        ...
        if (isDemo) {
            ...
            let message = `
                ...
                **Important Instructions**:
                ...
                3. Please retrieve the real, valid link for the following journal article. If the real link is unavailable, provide a sample link to guide me on how to reference journal articles
